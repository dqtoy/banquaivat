...
public class MauScript : MonoBehaviour
{
    ...
    private PlayerChiSo player_Stats;
    ...
    void Awake()
    {
        ...
        if (is_Player)
        {
            player_Stats = GetComponent<PlayerChiSo>();
        }
    ...
    void PlayerDied()
    {
        ...
        if (is_Player)
        {
            ...
            //GetComponent<PlayerDiChuyen>().enabled = false;
            //GetComponent<PlayerTanCong>().enabled = false;
            //GetComponent<WeaponManager>().GetCurrentSelectedWeapon().gameObject.SetActive(false);
            Debug.Log("Chet me tao roi");
