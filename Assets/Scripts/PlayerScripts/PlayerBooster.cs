...
public class PlayerBooster : MonoBehaviour
{
    ...
    private PlayerDiChuyen playerMovement;
    ...
    private Audio player_Footsteps;
    ...
    void Awake()
    {
        ...
        playerMovement = GetComponent<PlayerDiChuyen>();

        look_Root = transform.GetChild(0);

        player_Footsteps = GetComponentInChildren<Audio>();
